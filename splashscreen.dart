...
class SplashScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
     MaterialColor colorCustom = MaterialColor(0xFF008CEF, color);
    return MaterialApp(
      theme: new ThemeData(
        inputDecorationTheme: new InputDecorationTheme(
            labelStyle: new TextStyle(color: Color.fromRGBO(44, 130, 201, 1))),
        primarySwatch: colorCustom,
        textSelectionHandleColor: Color.fromRGBO(44, 130, 201, 1),
        hintColor: Color.fromRGBO(44, 130, 201, 1),
  ...
  Widget build(BuildContext context) {
    return new Center(
      ...
      child: LinearProgressIndicator(
        ...
        valueColor:
            new AlwaysStoppedAnimation<Color>(Color.fromRGBO(44, 130, 201, 1)),
      ),
    ));
  }
}
